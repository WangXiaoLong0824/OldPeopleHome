...
public class PayController {
    ...
    public void alipay(HttpServletResponse httpResponse,String name,String money) throws IOException {
        ...
        //付款金额，必填
        String total_amount =Integer.toString(r.nextInt(Integer.parseInt(money)));
        //订单名称，必填
        String subject =name;
        //商品描述，可空
        String body = null;
