...
public class MyRealm extends AuthorizingRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        ...
        List<String> keyList = shiroService.selectPowerKeyList(user.getUserid());
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        SysUser user = shiroService.selectUserInfoByCode(usercode);
        ...
        SimpleAuthenticationInfo sai = new SimpleAuthenticationInfo(user, user.getUserpassword(), saltByte, this.getName());
        return sai;
    }
    ...
    public static void main(String[] args) {
        ...
        Object salt = "liumengqi";//盐值 (用户账号、UUID、时间戳、随机字母 作为盐值，盐值必须保持唯一)
